  ...
  return (
    <div>
      <div>
        ...
        <div className="py-8 px-4 absolute bottom-0 left-0 bg-[#031c33] w-full">
          <button onClick={stop} className="text-white bg-[#a584fe] hover:bg-[#9772fc] px-4 py-2 mb-4 rounded font-bold">Restart</button>
          <div className="flex">
            <PlayPauseButton 
              isPlaying={isPlaying}
